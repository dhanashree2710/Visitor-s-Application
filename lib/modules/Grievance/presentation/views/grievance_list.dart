...
class _AdminGrievanceScreenState extends State<AdminGrievanceScreen> {
  ...
  Future<void> _sendMessage(Map grievance, String status) async {
    ...
    if (status == "Resolved") {
      ...
      closingMessage =
          "❌ Your grievance has been marked as invalid. Please contact support for clarification.";
    } else {
      closingMessage = "Thank you for reaching out to us. We will review it shortly.";
    }
...
""";
  ...
  /// Download file and open with native app
 Future<void> _downloadAndOpenFile(String url, String fileName) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            const Text("Admin Grievance Dashboard", style: TextStyle(color: Colors.white)),
        centerTitle: true,
        backgroundColor: KDRTColors.darkBlue,
        leading: IconButton(
          icon: const Icon(Icons.arrow_back, color: Colors.white),
                      ...
                      child: DataTable(
                        ...
                        rows: grievances.where((g) {
                          ...
                          return DataRow(cells: [
                            ...
                            DataCell(Text(grievance['grievance_details'])),
                           DataCell(
  Text(grievance['grievance_category'] ?? '')
),
                            DataCell(Text(grievance['priority_level'])),
                            DataCell(
                              Text(
